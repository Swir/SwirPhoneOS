...
CATALOGS = {
    "en": {
        ...
        "privacy": "No serial or IMEI property is requested. Reports contain untrusted device-reported values; review before sharing. Data never uploads automatically.",
    ...
    "pl": {
        ...
        "privacy": "Program nie żąda numeru seryjnego ani IMEI. Raport zawiera niezweryfikowane dane z telefonu; sprawdź je przed udostępnieniem. Brak automatycznego wysyłania danych.",
    ...
    "nb": {
        ...
        "privacy": "Serienummer og IMEI etterspørres ikke. Rapporten inneholder ubekreftede opplysninger fra telefonen; kontroller dem før deling. Ingen automatisk opplasting.",
