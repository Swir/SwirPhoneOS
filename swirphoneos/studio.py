...
class Studio:
    def __init__(
        ...
        style.configure("Notice.TLabel", foreground="#ffd58b", padding=(8, 2), background="#182333")
        ...
        # Keep the documented 640x500 minimum usable after adding review actions.
        # Interactive control padding stays unchanged; compact only non-control spacing.
        outer = ttk.Frame(root, padding=(12, 4))
        ...
        self.label(outer, "notice", wrap=True, style="Notice.TLabel").grid(row=1, column=0, sticky="ew", pady=(0, 2))

        fields = ttk.Frame(outer)
        fields.grid(row=2, column=0, sticky="ew")
        fields.columnconfigure(0, weight=1)
        field_header = ttk.Frame(fields)
        field_header.grid(row=0, column=0, columnspan=2, sticky="ew", pady=(0, 2))
        ...
        self.progress.grid(row=5, column=0, sticky="ew", pady=(2, 2))
        report_frame = ttk.Frame(outer)
        report_frame.grid(row=6, column=0, sticky="nsew")
        report_frame.rowconfigure(1, weight=1)
        report_frame.columnconfigure(0, weight=1)
        self.label(report_frame, "report").grid(row=0, column=0, sticky="w", pady=(0, 2))
        self.report = tk.Text(report_frame, wrap="word", state="disabled", height=8,
                              ...
                              relief="flat", padx=12, pady=4, font=("TkFixedFont", 10))
        ...
        self.label(outer, "privacy", wrap=True).grid(row=7, column=0, sticky="ew", pady=2)
