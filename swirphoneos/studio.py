...
class Studio:
    def __init__(self, root: tk.Tk, session: DiagnosticSession | None = None):
        ...
        style.configure("Notice.TLabel", foreground="#ffd58b", padding=12, background="#182333")
        style.configure("TButton", padding=(12, 9), background="#193650", foreground="#e5f0ff", bordercolor="#234762")
        ...
        ttk.Label(header, text="SwirPhoneOS", style="Title.TLabel").grid(row=0, column=1, sticky="w")
        self.label(header, "subtitle").grid(row=1, column=1, sticky="w")
        ...
        self.label(outer, "notice", wrap=True, style="Notice.TLabel").grid(row=1, column=0, sticky="ew", pady=(0, 12))
        ...
        self.progress.grid(row=5, column=0, sticky="ew", pady=(8, 12))
        ...
        self.label(outer, "privacy", wrap=True).grid(row=7, column=0, sticky="ew", pady=12)
